...
class Polls(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.poll_sugg_channel = int(os.getenv("DISCORD_SUPPORT_CHANNEL"))
    ...
    @help(
        ...
        parameters={
            "message_id": "Sie ist der Nachricht mit einem Rechtsklick auf die Umfrage zu entnehmen (Entwicklermodus in Discord müssen aktiv sein).",
            "question": "Die Frage, die gestellt werden soll (in Anführungszeichen).",
            "answers...": "Durch Leerzeichen getrennte Antwortmöglichkeiten (die einzelnen Antworten in Anführungszeichen einschließen).",
        },
